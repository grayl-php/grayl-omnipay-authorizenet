 ...
 */
class AuthorizeNetAuthorizeRequestControllerTest extends
    TestCase
{
    ...
    ): OmnipayGatewayCreditCard
    {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            OmnipayGatewayCreditCard::class,
            $credit_card
        );
     ...
     * @throws \Exception
     */
    public function testCreateAuthorizeNetAuthorizeRequestController(
        OrderController $order_controller,
        OmnipayGatewayCreditCard $credit_card
    ): AuthorizeNetAuthorizeRequestController {

        // Create the object
        $request = AuthorizeNetOrderHelper::getInstance()
            ->newAuthorizeNetAuthorizeRequestControllerFromOrder(
                $order_controller,
                $credit_card
            );
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            AuthorizeNetAuthorizeRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendAuthorizeNetAuthorizeRequestController(
        AuthorizeNetAuthorizeRequestController $request
    ): AuthorizeNetAuthorizeResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            AuthorizeNetAuthorizeResponseController::class,
            $response
        );
     ...
     * @return string
     */
    public function testAuthorizeNetAuthorizeResponseController(
        AuthorizeNetAuthorizeResponseController $response
    ): string {
     ...
     * @throws \Exception
     */
    public function testCreateOrderPaymentFromAuthorizeNetAuthorizeResponseController(
        OrderController $order_controller,
        AuthorizeNetAuthorizeResponseController $response
    ): OrderController {
     ...
     * @throws \Exception
     */
    public function testCreateAuthorizeNetCaptureRequestController(
        OrderController $order_controller,
        string $reference_id
    ): AuthorizeNetCaptureRequestController {

        // Create the object
        $request = AuthorizeNetOrderHelper::getInstance()
            ->newAuthorizeNetCaptureRequestControllerFromOrder(
                $order_controller,
                $reference_id
            );
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            AuthorizeNetCaptureRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendAuthorizeNetCaptureRequestController(
        AuthorizeNetCaptureRequestController $request
    ): AuthorizeNetCaptureResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            AuthorizeNetCaptureResponseController::class,
            $response
        );
     ...
     */
    public function testAuthorizeNetCaptureResponseController(
        AuthorizeNetCaptureResponseController $response
    ): void {
     ...
     * @throws \Exception
     */
    public function testCreateOrderPaymentFromCaptureResponseController(
        OrderController $order_controller,
        AuthorizeNetCaptureResponseController $response
    ): void {
