 ...
 */
class AuthorizeNetOrderHelper extends
    OmnipayOrderHelperAbstract
{
     ...
     * @throws \Exception
     */
    public function newAuthorizeNetAuthorizeRequestControllerFromOrder(
     ...
     * @throws \Exception
     */
    public function newAuthorizeNetCaptureRequestControllerFromOrder(
        OrderController $order_controller,
        string $reference_id
